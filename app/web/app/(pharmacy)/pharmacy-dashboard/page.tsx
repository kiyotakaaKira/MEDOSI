...
import { ScanBarcode, ShieldCheck, AlertTriangle, Pill, Activity, ArrowRight, ShieldAlert, CheckCircle2 } from "lucide-react";
  ...
  return (
    <div className="p-6 md:p-10 max-w-[1400px] mx-auto min-h-screen font-sans">
      ...
      >
        ...
        <motion.div variants={motionVariants.resolveIn}>
          <GlassPanel accentColor="cyan" className="p-6 h-full cursor-pointer hover:-translate-y-1 transition-transform" onClick={() => router.push('/verify')}>
            <div className="flex justify-between items-start mb-4">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }}>
            <GlassPanel accentColor="red" className="p-6 border-[#FF4D6D]/20">
              ...
              <p className="text-white/70 text-sm mb-4">
                The HealthMesh AI network has detected a 15% increase in cross-state duplicate prescription attempts for Schedule II narcotics over the past 24 hours.
              </p>
