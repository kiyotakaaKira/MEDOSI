            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <GlassPanel className="p-8">
                ...
                <div className="flex items-center gap-6 mb-8">
                  <div className="w-20 h-20 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-2xl text-white font-medium">JD</div>
                  <div>
                    <h3 className="text-2xl text-white font-medium">John Doe</h3>
                    <p className="text-[#2E6FFF] font-mono text-sm mt-1">ID: 1111-1111</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                  <div>
                    ...
                    <p className="text-white">May 12, 1984</p>
                  </div>
                  <div>
                 ...
                 <GlassPanel accentColor="green" className="p-8">
                    ...
                    <div className="p-4 bg-white/5 border border-white/10 rounded-xl mb-6">
                      <div className="flex justify-between items-start mb-2">
                        ...
                        <span className="px-2 py-1 bg-[#2ED9A3]/10 text-[#2ED9A3] border border-[#2ED9A3]/30 rounded text-xs">Verified</span>
                      </div>
